...
export function ContactSection() {
	...
	return (
		<section id="contact" className="scroll-mt-24 pt-14 md:pt-16">
					...
					<div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-10 items-center">
						...
						<form onSubmit={onSubmit} className="space-y-5">
							...
							<button
								...
								className="inline-flex items-center justify-center rounded-2xl bg-indigo-600 px-10 py-3 text-base font-semibold text-white shadow-lg shadow-indigo-600/20 hover:bg-indigo-500 transition disabled:opacity-60"
							>
